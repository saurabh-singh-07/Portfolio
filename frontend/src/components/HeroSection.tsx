...
function HeroSection() {
  ...
  window.open("/saurabh.pdf", "_blank");
};
  return (
    <motion.section
    ...
    >
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute left-1/2 top-[45%] size-137.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/35 blur-[130px] dark:bg-blue-500/20" />
      </div>

      <div className="flex min-h-screen w-full flex-col justify-around lg:flex-row">
        <div className="flex min-h-screen flex-col items-center justify-center px-6 pt-10 text-center lg:w-3/5 lg:items-start lg:pl-25 lg:text-left">
          ...
          <h2 className="my-4min-h-[100px] text-4xl font-bold md:min-h-0 md:text-5xl bg-linear-to-r from-indigo-600 via-violet-600 to-purple-700 bg-clip-text text-transparent">
            <ReactTyped
              strings={[
                "Frontend Developer",
          ...
          <div className="my-10 flex flex-col gap-4 sm:flex-row sm:gap-6">
            <button className="rounded-full bg-linear-to-r from-blue-500 to-indigo-600 px-7 py-3 font-medium text-white shadow-lg shadow-blue-500/20 transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/30 ">
              Get in Touch
            </button>

            <button onClick={handleViewResume} className="rounded-full border border-slate-300 bg-white/50 px-7 py-3 font-medium text-slate-700 backdrop-blur-md transition duration-300 hover:-translate-y-1 hover:border-blue-400 hover:text-blue-500 dark:border-white/10 dark:bg-white/5 dark:text-slate-200 dark:hover:border-blue-500 dark:hover:text-blue-400">
              View Resume
            </button>
          </div>
        </div>

        <div className="flex min-h-100 w-full items-center justify-center lg:min-h-screen lg:w-2/5 lg:pr-30">
          <div className="relative flex size-95 items-center justify-center rounded-full border border-orange-500/20 bg-orange-500/5 backdrop-blur-xl md:size-100 lg:size-110">
            ...
            <span className="text-xl font-medium text-orange-500 hover:scale-105 transition-all duration-300">
